...
def check_wallet() -> None:
    ...
    print("This process checks if the WALLET_PASSWORD in secrets.env can decrypt all accounts and the mnemonic.")
    print()
    ...
    if not storage.encrypted_mnemonic:
        ...
        try:
            ...
            # Get password (checked implicitly by KeyStorage init, but need explicit for decrypt)
