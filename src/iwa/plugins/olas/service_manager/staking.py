...
class StakingManagerMixin:
    ...
    def _fetch_staking_status_impl(self) -> Optional[StakingStatus]:
        ...
        return StakingStatus(
            ...
            current_safe_nonce=info["current_safe_nonce"],
            last_checkpoint_safe_nonce=info["last_checkpoint_safe_nonce"],
            current_mech_requests=info["current_mech_requests"],
            last_checkpoint_mech_requests=info["last_checkpoint_mech_requests"],
            activity_checker_address=staking.activity_checker_address,
            liveness_ratio=staking.activity_checker.liveness_ratio,
            ts_start=ts_start,
