...
class StakingContractInfo:
    ...
    chain: str
    agent_id: Optional[AgentType]  # None when stake() does not enforce agent IDs
...
# Govern VoteWeighting nominees refreshed on-chain 2026-05-12
# ---------------------------------------------------------------------------
STAKING_CONTRACTS: List[StakingContractInfo] = [
    ...
    StakingContractInfo(
        name="Pearl Beta Mech Marketplace V (10k OLAS)",
        address=EthereumAddress("0x536D04dBD9A2310152a0D2d8D18daDFCA8Bb26b0"),
        chain="gnosis",
        agent_id=AgentType.TRADER,
        marketplace=MarketplaceType.PEARL_MM,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Pearl Beta Mech Marketplace VI (10k OLAS)",
        address=EthereumAddress("0xac3Ed39D18d9C951BD2e7F0024114849C0a25295"),
        chain="gnosis",
        agent_id=AgentType.TRADER,
        marketplace=MarketplaceType.PEARL_MM,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Pearl Beta Mech Marketplace VII (10k OLAS)",
        address=EthereumAddress("0xB2303F9913f11131A74F4b05099Ced2043cc72C4"),
        chain="gnosis",
        agent_id=AgentType.TRADER,
        marketplace=MarketplaceType.PEARL_MM,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Pearl Beta Mech Marketplace VIII (5k OLAS)",
        address=EthereumAddress("0x12bdd401Ac300482f4017C64c6c930ee40424c08"),
        chain="gnosis",
        agent_id=AgentType.TRADER,
        marketplace=MarketplaceType.PEARL_MM,
        status=ContractStatus.ACTIVE,
    ...
    # LST uses the legacy StakingTokenLocked implementation. Its stake path is
    # gated by stakingManager/token checks and does not enforce agentIds.
    StakingContractInfo(
        name="LST (1k OLAS)",
        address=EthereumAddress("0x22FA631064A99c43196ec5f8324b73211Ced98f9"),
        chain="gnosis",
        agent_id=None,
    ...
    StakingContractInfo(
        name="Agents.fun 1 (100 OLAS)",
        address=EthereumAddress("0x2585e63df7BD9De8e058884D496658a030b5c6ce"),
        chain="base",
        agent_id=AgentType.MEME,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Agents.fun 2 (1k OLAS)",
        address=EthereumAddress("0x26FA75ef9Ccaa60E58260226A71e9d07564C01bF"),
        chain="base",
        agent_id=AgentType.MEME,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Agents.fun 3 (5k OLAS)",
        address=EthereumAddress("0x4D4233EBF0473Ca8f34d105A6256A2389176F0Ce"),
        chain="base",
        agent_id=AgentType.MEME,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Agents.fun 4 (100 OLAS)",
        address=EthereumAddress("0xb93607d2173f847a18567809dB51345d4EA38bAd"),
        chain="base",
        agent_id=AgentType.MEME,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
    ...
    # =====================================================================
    # BASE — New Govern nominees with non-trader agent IDs.
    # MarketplaceType.UNKNOWN means an unclassified activity checker, not an
    # unknown agent type; the agent IDs below are known AgentType members.
    # =====================================================================
    StakingContractInfo(
        name="Contribute Beta I (100 OLAS)",
        address=EthereumAddress("0xe2E68dDafbdC0Ae48E39cDd1E778298e9d865cF4"),
        chain="base",
        agent_id=AgentType.CONTRIBUTE,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
        bond_olas=100,
        required_requests=1,
    ...
    StakingContractInfo(
        name="Contribute Beta II (300 OLAS)",
        address=EthereumAddress("0x6Ce93E724606c365Fc882D4D6dfb4A0a35fE2387"),
        chain="base",
        agent_id=AgentType.CONTRIBUTE,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Contribute Beta III (500 OLAS)",
        address=EthereumAddress("0x28877FFc6583170a4C9eD0121fc3195d06fd3A26"),
        chain="base",
        agent_id=AgentType.CONTRIBUTE,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Pett.AI Agent Staking (20 OLAS)",
        address=EthereumAddress("0xFA0ca3935758cB81D35A8F1395b9Eb5a596ce301"),
        chain="base",
        agent_id=AgentType.PETT_AI,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
        bond_olas=20,
        required_requests=8,
    ...
    StakingContractInfo(
        name="Pett.AI Agent Staking 2 (40 OLAS)",
        address=EthereumAddress("0x00D544c10BDC0E9b0a71CeAF52C1342BB8f21c1D"),
        chain="base",
        agent_id=AgentType.PETT_AI,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="OneSoul Dating Agent Staking 1 (20 OLAS)",
        address=EthereumAddress("0x4D804a665097855b1158CD8045A819ee9fD0e540"),
        chain="base",
        agent_id=AgentType.ONESOUL,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.DEPLETED,
        bond_olas=20,
        required_requests=1,
    ...
    StakingContractInfo(
        name="OneSoul Dating Agent Staking 2 (20 OLAS)",
        address=EthereumAddress("0xc279Cf9Fc8DD0c4A58227ef1189cbb3f0f575F40"),
        chain="base",
        agent_id=AgentType.ONESOUL,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.DEPLETED,
    ...
    StakingContractInfo(
        name="Agent 103 Base Alpha I (10k OLAS)",
        address=EthereumAddress("0x51c5f4982B9b0B3c0482678f5847EA6228Cc8E54"),
        chain="base",
        agent_id=AgentType.AGENT_103,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
        bond_olas=10000,
        required_requests=20,
    ...
    StakingContractInfo(
        name="Agent 103 Base Alpha II (10k OLAS)",
        address=EthereumAddress("0x66A92CDa5B319DCCcAC6c1cECbb690CA3Fb59488"),
        chain="base",
        agent_id=AgentType.AGENT_103,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Marketplace Demand Alpha 2 Base (1k OLAS)",
        address=EthereumAddress("0xBE6E12364B549622395999dB0dB53f163994D7AF"),
        chain="base",
        agent_id=None,
        marketplace=MarketplaceType.DEMAND,
        status=ContractStatus.ACTIVE,
    ...
    # =====================================================================
    # MULTICHAIN — Supply marketplace contracts
    # =====================================================================
    StakingContractInfo(
        name="Marketplace Supply Alpha Ethereum (10k OLAS)",
        address=EthereumAddress("0x5A40e2661b3eE672e945445f885f975a51a6C461"),
        chain="ethereum",
        agent_id=None,
        marketplace=MarketplaceType.SUPPLY,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Marketplace Supply Alpha Optimism (10k OLAS)",
        address=EthereumAddress("0xBB375C8d8517e6956AF7044Fe676F2100505624f"),
        chain="optimism",
        agent_id=None,
        marketplace=MarketplaceType.SUPPLY,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Marketplace Supply Alpha Polygon (10k OLAS)",
        address=EthereumAddress("0x3aE11E2dd9a055af3dA61Ae2e36515D1612d7D93"),
        chain="polygon",
        agent_id=None,
        marketplace=MarketplaceType.SUPPLY,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Marketplace Supply Alpha Celo (10k OLAS)",
        address=EthereumAddress("0x6cc3A0d25E2AC7D8fF119Ef92d5523259C6DC821"),
        chain="celo",
        agent_id=None,
        marketplace=MarketplaceType.SUPPLY,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Marketplace Supply Alpha Arbitrum (10k OLAS)",
        address=EthereumAddress("0x646EcBE31DF12D17a949d65764187408f6bb095d"),
        chain="arbitrum",
        agent_id=None,
        marketplace=MarketplaceType.SUPPLY,
        status=ContractStatus.ACTIVE,
    ...
    # =====================================================================
    # OPTIMISM — Agent ID 40 (Optimus)
    # =====================================================================
    StakingContractInfo(
        name="Optimus Alpha II (100 OLAS)",
        address=EthereumAddress("0xBCA056952D2A7a8dD4A002079219807CFDF9fd29"),
        chain="optimism",
        agent_id=AgentType.OPTIMUS,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
        bond_olas=100,
        required_requests=4,
    ...
    StakingContractInfo(
        name="Optimus Alpha III (1k OLAS)",
        address=EthereumAddress("0x0f69f35652B1acdbD769049334f1AC580927E139"),
        chain="optimism",
        agent_id=AgentType.OPTIMUS,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Optimus Alpha IV (5k OLAS)",
        address=EthereumAddress("0x6891Cf116f9a3bDbD1e89413118eF81F69D298C3"),
        chain="optimism",
        agent_id=AgentType.OPTIMUS,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
    ...
    # =====================================================================
    # POLYGON — Agent ID 86 (Polymarket)
    # =====================================================================
    StakingContractInfo(
        name="Polymarket Beta I (100 OLAS)",
        address=EthereumAddress("0x9F1936f6afB5EAaA2220032Cf5e265F2Cc9511Cc"),
        chain="polygon",
        agent_id=AgentType.POLYMARKET,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
        bond_olas=100,
        required_requests=4,
    ...
    StakingContractInfo(
        name="Polymarket Beta II (1k OLAS)",
        address=EthereumAddress("0x22D58680F643333F93205B956a4Aa1dC203a16Ad"),
        chain="polygon",
        agent_id=AgentType.POLYMARKET,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
    ...
    StakingContractInfo(
        name="Polymarket Alpha III (10k OLAS)",
        address=EthereumAddress("0x8887C2852986e7cbaC99B6065fFe53074A6BCC26"),
        chain="polygon",
        agent_id=AgentType.POLYMARKET,
        marketplace=MarketplaceType.UNKNOWN,
        status=ContractStatus.ACTIVE,
...
def get_staking_contracts(
    ...
    agent_id: Optional[int | AgentType] = None,
...
def _build_trader_staking_compat() -> Dict[str, Dict[str, EthereumAddress]]:
    ...
    for c in get_staking_contracts(agent_id=AgentType.TRADER):
