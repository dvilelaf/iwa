...
def test_list_accounts_eoa(mock_console, mock_chain_interface):
    accounts = {
        "0x5B38Da6a701c568545dCfcB03FcB875f56beddC4": StoredAccount(address="0x5B38Da6a701c568545dCfcB03FcB875f56beddC4", tag="tag1")
    }
...
def test_list_accounts_with_tokens(mock_console, mock_chain_interface):
    ...
    token_balances = {
        "0x5B38Da6a701c568545dCfcB03FcB875f56beddC4": {"native": 1.5, "OLAS": 100.0}
    }
